        ...
        <div className="min-w-0">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              />
              <span className="text-[15px] text-[#6D6868]">{project.company}</span>
            </div>
            <span className="shrink-0 text-[15px] text-[#6D6868]">
              {project.number}
            </span>
          </div>
        ...
        <div className="mt-8 flex w-full flex-nowrap items-start justify-between gap-2 lg:mt-0">
          {project.info.map((col) => (
            <div key={col.label} className="min-w-0 shrink-0">
              ...
              <p className="mt-1 whitespace-nowrap text-[15px] leading-snug text-[#6D6868]">
                {col.value}
              </p>
            </div>
          ))}
