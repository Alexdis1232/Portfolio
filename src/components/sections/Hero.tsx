...
export function Hero() {
  return (
    <section className="hero-section pb-0">
      <div className="flex w-full flex-col items-center pt-[28px] sm:pt-[60px] lg:pt-[92px]">
        ...
        <LoadFadeInH1
          className="hero-title mt-[50px] w-full text-center text-[43px] font-normal leading-[1.1] text-[#0F0F0F] sm:mt-[62px] sm:text-[54px]"
